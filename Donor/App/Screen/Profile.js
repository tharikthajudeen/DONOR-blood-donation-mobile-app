...
const EditProfile = ({ navigation }) => {
  ...
  const [UserName, setUserName] = useState("Mr_Remo");
  const [password, setPassword] = useState("randompassword");
  const [country, setCountry] = useState("Colomo");
  const [BloodGroup, setBloodGroup] = useState("B+");
  const [Contact, setContact] = useState("0778924568");
    ...
    >
      ...
      <ScrollView>
        ...
        <View>
          ...
          >
            <Text style={{ ...FONTS.h4 }}>Blood Group</Text>
            <View
              style={{
                height: 44,
                width: "100%",
          ...
          >
            <Text style={{ ...FONTS.h4 }}>Contact Number</Text>
            <View
              style={{
                height: 44,
                width: "100%",
